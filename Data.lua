...
ns.DISENCHANT_POSSIBLES = {
    Weapon = {
        [Enum.ItemQuality.Good] = {
            {
                possibles = {{min = 1, max = 2, rate = 0.2, id = 10940}, {min = 1, max = 2, rate = 0.8, id = 10938}},
                level = 15,
            },
            {
                possibles = {
        ...
        [Enum.ItemQuality.Superior] = {
            ...
            {possibles = {{min = 1, max = 1, rate = 0.005, id = 20725}, {min = 1, max = 1, rate = 1, id = 14344}}},
        },
    ...
    Armor = {
        [Enum.ItemQuality.Good] = {
            {
                possibles = {{min = 1, max = 2, rate = 0.8, id = 10940}, {min = 1, max = 2, rate = 0.2, id = 10938}},
                level = 15,
            },
            {
                possibles = {
        ...
        [Enum.ItemQuality.Superior] = {
            ...
            {possibles = {{min = 1, max = 1, rate = 1, id = 11178}}, level = 50},
            {possibles = {{min = 1, max = 1, rate = 1, id = 14343}}, level = 55},
            {possibles = {{min = 1, max = 1, rate = 0.005, id = 20725}, {min = 1, max = 1, rate = 0.995, id = 14344}}},
        },
        [Enum.ItemQuality.Epic] = {
            {possibles = {{min = 2, max = 4, rate = 1, id = 11177}}, level = 45},
            {possibles = {{min = 2, max = 4, rate = 1, id = 11178}}, level = 50},
